                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full text-xs font-medium border transition ${
                        concern === c
                          ...
                          : "bg-white text-gray-600 border-gray-200 hover:border-[#C084A0]"
                      }`}
                    >
                      {c}
                    </button>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="bg-[#f0f7ff] rounded-2xl p-5 flex flex-col gap-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-800">{therapistName}</span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-800">{sessionType}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Focus Area</span>
                  <span className="font-medium text-gray-800">{concern}</span>
                </div>
                <div className="border-t border-blue-100 pt-3 flex justify-between text-sm">
                  <span className="text-gray-500">Fee</span>
                  <span className="font-bold text-gray-800">
                    {isProBono ? "Free (Pro Bono)" : `₹${fee}`}
                  </span>
                </div>
              </div>
              ...
              {!isProBono && parseInt(fee) > 0 && (
                <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4 text-sm text-blue-700 flex items-center gap-2">
                  💳 You will be redirected to a secure Razorpay payment page to complete your booking.
                </div>
              )}
          ...
          {step === 4 && (
            <div className="text-center flex flex-col items-center gap-4 py-6">
              ...
              <div className="flex flex-col gap-3 w-full max-w-xs mt-4">
                <Link
                  href="/dashboard"
                  className="bg-[#4A90D9] text-white font-semibold py-3 rounded-xl hover:bg-[#357ABD] transition text-center"
                >
                  Go to Dashboard
                </Link>
                <Link
                  href="/therapists"
                  className="bg-white border border-gray-200 text-gray-600 font-medium py-3 rounded-xl hover:bg-gray-50 transition text-center text-sm"
                >
